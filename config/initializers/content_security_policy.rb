...
Rails.application.configure do
  config.content_security_policy do |policy|
    ...
    connect_whitelist = ["client.crisp.chat", "wss://client.relay.crisp.chat", "storage.crisp.chat", "integration.lasuite.numerique.gouv.fr", "lasuite.numerique.gouv.fr", "app.franceconnect.gouv.fr", "openmaptiles.data.gouv.fr", "openmaptiles.geo.data.gouv.fr", "openmaptiles.github.io", "tiles.geo.api.gouv.fr", "data.geopf.fr", "pmtiles-data.s3.rbx.io.cloud.ovh.net"]
