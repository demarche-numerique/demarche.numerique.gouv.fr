...
describe Users::ProfilController, type: :controller do
  ...
  describe 'session revocation' do
    ...
    describe '#revoke_session' do
      ...
      # A profile page left open while the session died elsewhere. Acting on a
      # row that is already dead must close nothing and cost nothing.
      it 'answers 404 for a row that is already revoked, and touches nothing else' do
