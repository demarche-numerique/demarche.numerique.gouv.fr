    ...
    context 'when admin is the owner of the procedure' do
      ...
      context 'when the admin checks all options' do
        ...
        it 'clones everything', :slow do
          ...
          expect(Procedure.last.draft_revision.root_public_types_de_champ.count).to eq 1
          expect(Procedure.last.draft_revision.root_private_types_de_champ.count).to eq 1
      ...
      context 'when the admin unchecks all options' do
        ...
        it 'clones only mandatory params' do
          ...
          expect(Procedure.last.draft_revision.root_public_types_de_champ.count).to eq 0
          expect(Procedure.last.draft_revision.root_private_types_de_champ.count).to eq 0
