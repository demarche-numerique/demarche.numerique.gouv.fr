  ...
  describe "champ_values_for_export" do
    context 'with integer_number' do
      ...
      it 'give me back my decimal number' do
        ...
        }.to change { dossier.reload.champ_values_for_export(procedure.reload.types_de_champ_for_procedure_export, format: :xlsx) }
    ...
    context 'with a unconditionnal procedure' do
      ...
      context "when procedure published" do
        ...
        it "should have champs from all revisions" do
          ...
          # the text champ, removed from the newest revision, is appended at the
          # end of its last-known container (the scope root) — aggregate policy
        ...
        context 'within a repetition having a type de champs commune (multiple values for export)' do
          it 'works' do
            ...
            type_champs = proc_test.aggregated_public_type_de_champs.find(&:repetition?).flat_children
