...
describe PiecesJustificativesService do
  describe 'pjs_for_champs' do
    let_it_be(:procedure) { create(:procedure, public_type_de_champs: [{ type: :piece_justificative, mandatory: false }, { type: :repetition, mandatory: false, children: [{ type: :piece_justificative, mandatory: false }] }]) }
    let(:dossier) { create(:dossier, procedure: procedure) }
    let(:dossiers_scope) { Dossier.where(id: dossier.id) }
    let_it_be(:witness) { create(:dossier, procedure: procedure) }
  ...
  describe '.generate_dossiers_export' do
    let(:user_profile) { build(:administrateur) }
    let_it_be(:procedure) { create(:procedure, public_type_de_champs: [{ type: :repetition, children: [{ type: :piece_justificative }] }]) }
    let_it_be(:dossier) { create(:dossier, :with_populated_champs, procedure: procedure) }
    let(:dossiers_scope) { Dossier.where(id: dossier.id) }
    let(:export_template) { nil }
  ...
  describe 'carte champ static map' do
    let_it_be(:procedure) { create(:procedure, public_type_de_champs: [{ type: :carte }, { type: :piece_justificative }]) }
