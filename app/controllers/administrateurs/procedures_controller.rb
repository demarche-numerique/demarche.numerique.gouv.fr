...
module Administrateurs
  class ProceduresController < AdministrateurController
    ...
    before_action :retrieve_procedure, only: [:show, :update, :champs, :annotations, :modifications, :parcours, :edit, :zones, :monavis, :update_monavis, :accuse_lecture, :update_accuse_lecture, :publication, :publish, :transfert, :close, :confirmation, :allow_expert_review, :allow_expert_messaging, :experts_require_administrateur_invitation, :reset_draft, :publish_revision, :check_path, :api_champ_columns, :commune_info, :path, :update_path, :rdv, :update_rdv, :pro_connect_restricted, :update_pro_connect_restricted]
    ...
    def parcours
      ...
      @branch_trees = @procedure.draft_revision.branch_trees
    end
