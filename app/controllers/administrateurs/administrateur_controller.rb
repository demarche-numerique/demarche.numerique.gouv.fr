...
module Administrateurs
  class AdministrateurController < ApplicationController
    ...
    def alert_for_missing_siret_service
      ...
      errors = [I18n.t("shared.procedures.no_siret")] # rubocop:disable DS/GlobalI18nTranslate

      procedures.each do |p|
        errors << I18n.t('shared.procedures.add_siret_to_service_without_siret_html', link: edit_admin_service_path(p.service, procedure_id: p.id), nom: p.libelle) # rubocop:disable DS/GlobalI18nTranslate
      end
